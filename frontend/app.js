document.addEventListener("DOMContentLoaded", () => {
    ...
    async function performDiagnostic(file) {
        ...
        try {
            ...
            setTimeout(() => {
                // Generate a stable hash based on file details so same file yields same prediction
                let fileHash = 0;
                ...
                const isMockStressed = (fileHash % 2) === 0;
                const seed = (fileHash % 100) / 100;
                const mockConfidence = 0.72 + seed * 0.23; // Stable between 72% and 95%
